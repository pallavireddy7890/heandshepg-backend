...
class EmailVerificationService:
    ...
    def create_verification(
        ...
        if existing and not existing.is_expired():
            ...
            print("\n" + "="*50)
            print(f"UPDATED EMAIL OTP for {email_lower}: {existing.otp_code}")
            print("="*50 + "\n")
        ...
        print("\n" + "="*50)
        print(f"EMAIL OTP for {email_lower}: {otp_code}")
        print("="*50 + "\n")
        ...
        <body>
            <div class="container">
                <div class="header">
                    ...
                    <h2 style="margin: 8px 0 0; font-size: 20px; font-weight: normal; opacity: 0.9;">📧 Verify Your Email</h2>
                </div>
                <div class="content">
